...
$limit=10*($se-1);
$query="SELECT si,bookname,author,bgp,year FROM submitbook WHERE bookname LIKE '%$book%' OR author LIKE '%$book%' GROUP BY bookname LIMIT $limit,10 ;";
...
<div style="clear:both;"></div>
				   <div id="booknav" style="float:right; margin-top:15px;">
				      <?if ($se!=1){echo "<a href='search.php?se=".($se-1)."&book=$book'><img src='./images/previous.png'></img></a>";
}?>
				       <a href='search.php?se= <? echo ($se+1);?>&book=<? echo $book;?>'><img src="./images/next.png"></img></a>
				   </div>
			   </div>
			   <div style="clear:both;"></div>
		   </div>
